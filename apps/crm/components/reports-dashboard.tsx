...
const monthlyData = [
  { month: "Jan", clients: 45, properties: 23, inquiries: 89, revenue: 125000 },
  { month: "Feb", clients: 52, properties: 31, inquiries: 102, revenue: 145000 },
  { month: "Mar", clients: 48, properties: 28, inquiries: 95, revenue: 135000 },
  { month: "Apr", clients: 61, properties: 35, inquiries: 118, revenue: 165000 },
  { month: "May", clients: 55, properties: 42, inquiries: 134, revenue: 185000 },
  { month: "Jun", clients: 67, properties: 38, inquiries: 145, revenue: 195000 },
]

const inquiryStatusData = [
  { name: "New", value: 45, color: "#3b82f6" },
  { name: "Follow-Up", value: 32, color: "#f59e0b" },
  { name: "Closed", value: 23, color: "#10b981" },
]

const propertyTypeData = [
  { type: "Sale", count: 45, revenue: 2250000 },
  { type: "Rental", count: 38, revenue: 456000 },
]

const agentPerformanceData = [
  { name: "Sarah Johnson", clients: 23, inquiries: 45, closed: 18, revenue: 450000 },
  { name: "Mike Chen", clients: 19, inquiries: 38, closed: 15, revenue: 375000 },
  { name: "Emily Davis", clients: 21, inquiries: 42, closed: 17, revenue: 425000 },
  { name: "David Wilson", clients: 17, inquiries: 35, closed: 14, revenue: 350000 },
]
